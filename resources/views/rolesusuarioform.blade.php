    ...
    <div class="col-md-6 themed-grid-col">
      <div class="container">
        <h1>Roles de Usuario</h1>
          ...
          {{ Form::open(array('route' => ['refreshroles', $usuario->id_user]))  }}
          ...
          {{ Form::label('roles', 'Roles asignados:') }}</br>
          {{ Form::label('roles', '(Marque los Roles asignados si desea desvincularlos del Usuario)') }}

          @foreach($user_roles as $user_roles)

          <div class="form-group col-sm-12">

            {{ Form::checkbox('borrarRoles[]', $user_roles)  }}
            {{ Form::label('roles', $user_roles) }}
          </div>
          ...
          @foreach($roles as $roles)
                    ...
                    <div class="form-group col-sm-12">
                        ...
                        {{ Form::checkbox('addRoles[]', $roles->name)  }}
                        {{ Form::label('roles', $roles->name) }}
                    </div>
