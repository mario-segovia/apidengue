  ...
  <div class="row mb-3">
    ...
    <div class="col-md-6 themed-grid-col">
      <div class="container">
        ...
        <a href="{{ route('entidades.index') }}" class="btn btn-secondary">Volver</a>
          {{ Form::model( $entidad, ['route' => ['entidades.update', $entidad->id], 'method' => 'patch'])  }}
          ...
          <div class="form-group col-sm-12">
            ...
            {{ Form::text('localidad', null,['class' => 'form-control', 'readonly'])  }}
          </div>
          <div class="form-group col-sm-12">
