...
class HistorialActivoController extends Controller
{
   public function activo()
   {
    $activos=DB::table('caso_positivos')
        ...
        ->join('controls','controls.id','=', 'caso_positivos.paciente_id')
